...
Задача: Разработка системы рейтинга футбольных игроков.
...
1. Хранение данных по статистике игроков
   Необходимо создать возможность для хранения данных о футбольных игроках и их статистике за каждый матч. Статистика должна включать информацию, которая будет использоваться для расчета рейтинга игроков в зависимости от их роли (вратарь, нападающий, защитник,   
   полузащитник).
...
3. Расчет рейтинга игроков
   ...
   Роль, которую выполняет игрок (например, у вратаря могут быть одни критерии, у нападающего — другие). По 3-4 критерия на роль.
   Например: (количество забитых голов * 3 + количество голевых передач * 2 + количество ударов по воротам * 1 ) 
   Вес матча. Важные матчи влияют на рейтинг сильнее. Реализовать в виде коэффициента. Например: рейтинг * вес матча
